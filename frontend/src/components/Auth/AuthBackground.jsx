...
const AuthBackground = ({children}) => {
    ...
    const { darkMode , toggleDarkMode} = usePortal()
  return (
    <div className={`relative min-h-screen flex flex-col  items-center justify-center bg-login-bgg from-orange-200 to-blue-200 dark:bg-deep_blue_black backdrop-blur-[20px] py-6 px-4 overflow-hidden`}>
                {/* bg desgins */}
