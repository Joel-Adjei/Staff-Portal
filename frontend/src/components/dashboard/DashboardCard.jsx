...
const DashboardCard=({className , Icon, title , value})=>{
    return(
        <div className={`${className}  bg-white dark:bg-blue-950 rounded-xl p-6 shadow-lg border-l-4 border-orange-400 dark:border-blue-300 transform hover:scale-102 transition-transform duration-200`}>
